...
insert into `Doctors` values ( 'D103101', '장보고', '1979-07-28', 'M' ,'103' ,'과장' ,'010-3101-1979' ,'jangbg@nw.com');
insert into `Doctors` values ( 'D104101', '선덕여왕', '1984-06-15', 'F' ,'104' ,'과장' ,'010-4101-1984' ,'gueen@bw.com');
insert into `Doctors` values ( 'D105101', '강감찬', '1965-10-21', 'M' ,'105' ,'과장' ,'010-5101-1965' ,'kang@nw.com');
insert into `Doctors` values ( 'D106101', '신사임당', '1972-11-28', 'F' ,'106' ,'과장' ,'010-6101-1972' ,'sunsa@nw.com');
...
insert into `Patients` values ( 'P103101', 'D103101', 'N103101', '이정재', '750611-1234567' , 'M' , '서울' , '010-1102-7607' , Null, '배우');
insert into `Patients` values ( 'P102102', 'D102104', 'N102103', '전지현', '890530-1234567' , 'F' , '대전' , '010-1103-8905' , 'jjh@naver.com', '자영업');
insert into `Patients` values ( 'P104101', 'D104101', 'N104101', '이나영', '790413-1234567' , 'F' , '대전' , '010-2102-7904' , 'lee@naver.com', '회사원');
...
insert into `Nurses` values ( 'N104101', '김태희', '1979-08-28', 'F', '104' , '주임' , '010-3101-7980' , 'taeh@bw.com' );
